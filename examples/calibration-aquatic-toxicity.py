...
my_data = genfromtxt('/Users/shachideshpande/Downloads/online-learning-master/examples/qsar_aquatic_toxicity.csv', delimiter=';', dtype=None)
...
eta = 10 # this a practical effective learning rate
...
# save the figures
# plt.show()
plt.savefig('recalibration-aquatic-toxicity-total-gaussian_ewa_recalib.png')
