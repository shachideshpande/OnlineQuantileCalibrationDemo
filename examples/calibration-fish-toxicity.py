...
my_data = genfromtxt('/Users/shachideshpande/Downloads/online-quantile-calibration-master/examples/qsar_fish_toxicity.csv', delimiter=';', dtype=None)
...
# create a dataset
T = 90 # number of time steps of online learning
...
for reps in range(10):
  ...
  # save the figures
  # plt.show()
  plt.savefig(str(reps)+'recalibration-fish-toxicity-total-gaussian_ewa_recalib.png')
